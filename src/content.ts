...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    category: "ova",
    year: "2010–2011",
    title: { zh: "第12.5话 / 第25话", ja: "第12.5話 / 第25話" },
    meta: { zh: "第1期特别篇", ja: "第1期 特別編" },
    description: {
      zh: "补充本篇间隙中的池袋骚动与人物日常。",
      ja: "本編の合間に起きた池袋の騒動と人物たちの日常を補完する。",
    },
    details: {
      zh: ["第12.5话《天网恢恢》", "第25话《天下泰平》", "收录于影像制品的番外篇"],
      ja: ["第12.5話「天網恢恢」", "第25話「天下泰平」", "映像商品収録の番外編"],
    },
  ...
  },
  {
    ...
    category: "ova",
    year: "2015–2016",
    title: { zh: "×2 外传三篇", ja: "×2 外伝 三編" },
    meta: { zh: "第4.5 / 13.5 / 19.5话", ja: "第4.5 / 13.5 / 19.5話" },
    description: {
      zh: "分别对应《承》《转》《结》的外传篇，扩展群像与城市细节。",
      ja: "『承』『転』『結』に対応する外伝で、群像と街の細部を広げる。",
    },
    details: {
      zh: ["第4.5话《我的心是火锅的形状》", "第13.5话《恋爱故事铿锵作响》", "第19.5话《Dufufufu!!》"],
      ja: ["第4.5話「私の心は鍋模様」", "第13.5話「お惚気チャカポコ」", "第19.5話「デュフフフ!!」"],
    },
